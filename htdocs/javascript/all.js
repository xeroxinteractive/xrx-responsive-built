...
$(document).ready(function(){
	function scrollDepth() {
		jQuery.scrollDepth({
		  ...
		  pixelDepth: false,
		  percentage: false,
		  elements: ['.homepage-promos .hero-promo .equal-col', '.homepage-promos .promos .small-promo-a',  '.homepage-promos .promos .small-promo-b',  '.homepage-promos .promos .resource-desk', '.social-container .media-feature', '.social-container .blog-side' , '.social-container .social-side .twitter .tweet', '.social-container .social-side .linkedin .linkedin-text'],
