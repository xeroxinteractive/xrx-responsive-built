...
// force personalization when mbox is suppressed and persona is supplied in query string
if ( typeof xrx_persona_nombox !=== 'undefined' && xrx_persona_nombox != '' ) {
    activeContainer(xrx_persona_nombox)
}
