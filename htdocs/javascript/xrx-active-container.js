    ...
    if ($("#active-container-tmpl")[0]) {
        ...
        $.each($acJSON, function(key, value) {
            ...
            if (key === persona) {
                ...
                obj.heroLarge.blurb = obj.heroLarge.blurb || '';
                obj.smallPromoA.blurb = obj.smallPromoA.blurb || '';
                obj.smallPromoB.blurb = obj.smallPromoB.blurb || '';
                var $promos = {};
                ...
                $promos.heroLargeBlurb = obj.heroLarge.blurb;
                ...
                $promos.smallPromoABlurb = obj.smallPromoA.blurb;
                ...
                $promos.smallPromoBBlurb = obj.smallPromoB.blurb;
                ...
                $("#active-container-tmpl").prepend(htmlOutput).addClass('persona-' + persona);
              ...
              /*  var colorChange = Math.random() < 0.5 ? 'lavender-promo' : 'violet-promo';
                ...
                if (!$('#small-promo-a').hasClass(colorChange)) {
                    $('#small-promo-a').removeClass('violet-promo');
                    $('#small-promo-a').addClass(colorChange);
                }*/
                var colorChange = Math.random() < 0.5 ? 'lavender-promo' : 'violet-promo';
                       //$color = colorChange;
                       //var arr = ['lavender-promo', 'violet-promo'],
