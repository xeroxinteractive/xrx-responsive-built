...
(function($) {
	...
	**/
	...
	if(isIE8()){
		...
		//console.log("Paint stars inicio");
...
/**
* Sets click listeners for tabs in homepage
**/
function xrx_setClickListenerForTabs(){
...
/**
* Configure sliders for Software and Hardware Solutions in homepage
* @param {string} idSlider: Id slider carousel
* @param {string} idTab: Id tab in desktop screens
**/
