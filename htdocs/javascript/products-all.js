...
$("body").on(
	...
	function(e) {
		...
		$(".xrx_item_gl_product_finder").removeClass("list");
	});
$("body").on(
	"click",
	"#xrx_button_list",
	function(e) {
		$(this).parent().find("div").removeClass("active");
		$(this).addClass("active");	
		$(".xrx_item_gl_product_finder").addClass("list");
	});
/**
 * Xerox already has JavaScript for clearing selections
xrx_clearSelections();
...
function xrx_configureAccordion(idAccordion){
	...
	$('body').on(
		"click",
		idAccordion+">.panel>.panel-heading>.panel-title>a",
		function(e) {
...
function xrx_compareAction(){
	var divCategory=$("#xrx_category-page");
