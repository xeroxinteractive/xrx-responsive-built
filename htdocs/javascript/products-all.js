...
function xrx_configureSliderGeneric(idSlider){
	...
	var loopMobile=numItems<=2?false:true;
    owl.owlCarousel(
  	{
    	dots:true,
    	loop: loopMobile,
		...
		onInitialized : function(elem){
			...
			var htmlBlanck='<div class="owl-item hidden-xs" style="width: '+xrx_widthItem+'px; margin-right: 0px;"><div class="item"><div class="xrx_item_generic_module" style="height: 222px;"></div></div></div>';
			for(var i=0;i<itemsBlankToAdd;i++){
				owl.find(".owl-stage").append(htmlBlanck);
			}
...
* Remove blank items
**/
function xrx_removeBlankItemsForMobiles(idCarousel){
	var owlCarousel=$("#"+idCarousel);
	$("#"+idCarousel+".item .xrx_item_generic_empty").each(function(){
		var xrx_index=$(this).parent().index();
		owlCarousel.data("owlCarousel").removeItem(xrx_index);
	});
}
