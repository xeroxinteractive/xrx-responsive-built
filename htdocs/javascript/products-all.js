...
(function($) {
	...
	/*var xrx_HeadingSpecs=$(".xrx_content_specs.xrx_content_specs_multitable .xrx_accordion_xerox_style .panel .panel-heading .panel-title a");
	xrx_HeadingSpecs.click(function(){
		setTimeout(function(){
			var xrx_Multitable=$(".xrx_content_specs.xrx_content_specs_multitable");
			var xrx_XeroxLinks=$(".xrx_container_hours_links");
			console.log("click title "+xrx_Multitable.height());
			if(xrx_Multitable.height()>540){
				xrx_XeroxLinks.css("margin-top","-305px");
			}
			else{
				xrx_XeroxLinks.css("margin-top","-117px");
			}
		},500);
	});*/
})(jQuery);
