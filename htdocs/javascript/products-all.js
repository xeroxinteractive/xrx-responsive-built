...
function xrx_sitecatalyst_action($action_label) {
	...
	if (typeof xrx_sc_synthetic_lid_event == 'function') {
		xrx_sc_synthetic_lid_event($action_label);
	}
...
function xrx_setJumpLinkActionToHref(){
	...
	$('a.xrx_jump_link[href*=#]:not([href=#])').click(function() {
	    if (location.pathname.replace(/^\//,'') == this.pathname.replace(/^\//,'') && location.hostname == this.hostname) {
	      ...
	      xrx_sitecatalyst_action($(this).text() + '-nav');
...
function xrx_collapse_sitecatalyst() {
	var $collapsible_title;
	$('.collapse').on('show.bs.collapse', function () {
		$collapsible_title = $.trim($(this).parent().find('.panel-heading .panel-title a')
		  .text().toLowerCase());
	  xrx_sitecatalyst_action($collapsible_title + '-open');
	});
	$('.collapse').on('hide.bs.collapse', function () {
		$collapsible_title = $.trim($(this).parent().find('.panel-heading .panel-title a')
		  .text().toLowerCase());
	 	xrx_sitecatalyst_action($collapsible_title + '-close');
	});

}
xrx_collapse_sitecatalyst();
