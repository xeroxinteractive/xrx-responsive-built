    ...
    owl.owlCarousel(
  	{
		...
		onInitialized : function(elem){
			...
			var htmlBlank='<div class="owl-item hidden-xs" style="width: '+xrx_widthItem+'px; margin-right: 0px;"><div class="item"><div class="xrx_item_generic_module xrx_item_generic_empty" style="height: 222px;"></div></div></div>';
...
function xrx_checkFillEmptySizeCarouselSAS(idCarousel){
	...
	if(blankItems>=1&&blankItems<=3){
		var htmlItem="<div class='item visible-md'><div class='xrx_item_generic_module xrx_item_generic_empty'></div></div>";
