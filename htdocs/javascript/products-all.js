...
$(window).resize(function(){
	...
	console.log(selectOptions.hasClass("collapsed")+"resize "+$(window).width());
...
(function($) {
	...
	if(xrx_rowSpecs.hasClass("xrx_compare")){
		...
		console.log("console has class xrx_compare");
		xrx_imagesSpecs.removeClass("col-md-4").addClass("hidden");
		xrx_contentSpecs.removeClass("col-md-8").addClass("col-md-12");
	}
	else{
...
function xrx_configureSliderGeneric2Tablet(idSlider,idTabJQ){
    ...
    owl.owlCarousel({
		items : 3, //10 items above 1000px browser width
		itemsDesktop : [1000,3], //5 items between 1000px and 901px
		itemsDesktopSmall : [970,2], // betweem 900px and 601px
		itemsTablet: [600,1], //2 items between 600 and 0
		itemsMobile : [600,1],
		afterInit : function(elem){
			owl.find(".owl-controls").addClass("visible-sm").addClass("visible-xs");
			var that = this;
			that.owlControls.prependTo(elem);
		}
  	});
