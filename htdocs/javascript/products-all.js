    ...
    owl.owlCarousel(
  	{
		...
		onInitialized : function(elem){
			...
			owl.bind("DOMSubtreeModified",function(){
				//console.log("cambio dom");
			  	xrx_checkFixHeightItems(idSlider);
			});
		},
		onResize:function(){
...
function xrx_checkFixHeightItems(idCarousel){
	...
	var maxHeightItem=0;
	setTimeout(function(){
		itemsToHeight.each(function(){
			var heightCurrent=$(this).innerHeight()-0;
			//console.log(heightCurrent);
			if(heightCurrent>maxHeightItem){
				maxHeightItem=heightCurrent;
...
function xrx_checkFillEmptySizeCarouselSAS(idCarousel){
	...
	if(blankItems>=1&&blankItems<=3){
		var htmlItem="<div class='item'><div class='xrx_item_generic_module xrx_item_generic_empty'></div></div>";
