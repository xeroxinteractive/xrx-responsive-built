...
(function($) {
	...
	$('#xrx_newsletter_signup_btn').on("click", function() {
		...
		if (xrx_newsletter_href != null && xrx_newsletter_href.length > 0)
			...
			xrx_newsletter_href = "/perl-bin/formeng.pl?form=enewsletter&email=" + $('#xrx_newsletter_signup_email').val();
	});
	
	$("input#xrx_newsletter_signup_email").on("keypress", function(e) {
		if (e.which == 13) {
			e.preventDefault();
