...
(function($) {
	...
	$('#xrx_newsletter_signup_btn').on("click", function() {
		...
		if (xrx_newsletter_href != null && xrx_newsletter_href.length > 0)
			$(this).attr('href', $(this).attr('href') + "&email=" + $('#xrx_newsletter_signup_email').val());
		else
			$(this).attr('href', "/perl-bin/formeng.pl?form=enewsletter&email=" + $('#xrx_newsletter_signup_email').val());
	});
