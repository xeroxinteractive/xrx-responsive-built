...
(function($) {
	...
	**/
	...
	if(isIE8()){
		...
		//Solver lines cut in ie8
		$(".xrx_products_module .xrx_row_details_table > .row > div:last-child").css("min-height","40px");
		$(".xrx_products_module .xrx_row_details_table > .row > div.xrx_ie_height").css("min-height","60px");
		...
		$(".xrx_ul_navigation_banner a .xrx_icon_item_banner_hero.xrx_icon_item_banner_hero_user").css({"background-image":"","background":""});
		$(".xrx_ul_navigation_banner a:hover .xrx_icon_item_banner_hero.xrx_icon_item_banner_hero_user").css({"background-image":"","background":""});
		$(".xrx_ul_navigation_banner a .xrx_icon_item_banner_hero.xrx_icon_item_banner_hero_find").css({"background-image":"","background":""});
		$(".xrx_ul_navigation_banner a:hover .xrx_icon_item_banner_hero.xrx_icon_item_banner_hero_find").css({"background-image":"","background":""});
		$(".xrx_ul_navigation_banner a .xrx_icon_item_banner_hero.xrx_icon_item_banner_hero_chat").css({"background-image":"","background":""});
		$(".xrx_ul_navigation_banner a:hover .xrx_icon_item_banner_hero.xrx_icon_item_banner_hero_chat").css({"background-image":"","background":""});

		$(".xrx_products_module_specs.xrx_product_module_detail_reviews .xrx_row_third_reviews ul li:first-child").css({"min-width":"170px"});
		//$(".xrx_icon_header_specs.xrx_icon_pdf").css({"background-image":"","background":"",backgroundSize:"cover"});
		//$(".xrx_icon_header_specs.xrx_icon_view").css({"background-image":"","background":""});
		//$(".xrx_icon_header_specs.xrx_icon_video").css({"background-image":"","background":""});
...
(function ($) {
 ...
 var Environment = {
    ...
    if (Environment.isMobile()) {
        console.log("Entra a select picker");
        $('.selectpicker').selectpicker({
            mobile: true
        });
    } else {
        console.log("Entra a select picker no mobile");
        if (isIE8()) {
            $('select').selectpicker({
                size: false
            });
