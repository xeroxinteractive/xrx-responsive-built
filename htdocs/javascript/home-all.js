...
*/
	  	...
	  	//sort by date
	  	data = sortByKey($thedata, 'updated');
	  	var isLiFound = false;
	  	...
	  	for (i = 0; i < data.length; i++) {
	  	    ...
	  	    obj.image_link = obj.image_link || '';
	  	   	...
	  	   	if ($medium === 'twitter') {
	  	   		...
	  	   		/*<div class="row no-gutter"><a href="' + $link + '" target="_blank"><div class="feed-left col-md-4 col-sm-6 col-xs-12">' + $image + '</div><div class="feed-right col-md-8 col-sm-6 col-xs-12"><span class="title">' + $title + '</span><span class="author">' + obj.account + '</span></div><p>' + $excerpt + '</p>
	  	   		</a><p><a target="_blank" href="' + $LIshare + '">Share</a> ' + $LItimeago + '</p>
	  	   		</div>*/

	  	   		$('.social-side .linkedin').append('<a class="linkedin-text" href="' + $link + '" target="_blank"><div class="row no-gutter"><div class="feed-left col-md-4 col-sm-6 col-xs-12">' + $image + '</div><div class="feed-right col-md-8 col-sm-6 col-xs-12"><div><span class="title">' + $title + '</span><span class="author">by ' + obj.account + '</span></div></div><div class="col-md-12 col-sm-6 col-xs-12"><p>' + $excerpt + '</p></div></div></a><p><a target="_blank" href="' + $LIshare + '">Share</a> ' + $LItimeago + '</p>');
