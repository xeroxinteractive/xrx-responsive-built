...
if (document.getElementById("player")) {
  ...
  /**
  * Need to reset listeners because of conflict with SiteCatalyst
  **/
  function resetEventListeners(){
    if (window.addEventListener){
      player.addEventListener('onStateChange', 'onPlayerStateChange', false);
    } 
    else if (window.attachEvent){
      window.attachEvent('onStateChange', 'onPlayerStateChange');
    } 
  }
