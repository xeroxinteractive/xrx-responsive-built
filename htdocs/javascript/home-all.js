...
$('.rd-selection ul a:not(#all)').click(function(e) {
	...
	$this.addClass('rd-selected-clone');
...
// all blog selector
$('.rd-selection ul a#all').click(function(e) {
...
function getResults(){
	...
	$.ajax({
		type: "GET",
		dataType: "jsonp",
		url: 'http://xerox.elicitapp.com/s.ashx?q=services%20&r=17&sn=http%3A%2F%2Fwww.xerox.com&su=xerox_user&l=en-US&p=0&f=http%3A%2F%2Fwww.xerox.com%2F&_=1421247885992'
