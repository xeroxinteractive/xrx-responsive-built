...
function allBlogLoop() {
	...
	for (i = 0; i < $data.length; i++) {
	    ...
	    obj.comments_count = obj.comments_count || '0';
	   	...
	   	$content = '<div class="feed-left col-md-6 col-sm-12 col-xs-12"><a class="blog-image" target="_blank" href="' + $link + '">' + $date + '' + $image + '</a></div><div class="feed-right col-md-6 col-sm-12 col-xs-12"><h4><a target="_blank" href="' + $link + '">' + obj.title + '</a></h4><p>' + $comments_count + ' comments</p><p>' + $excerpt + '</p></div>';
	   if ($index <= 2) {
...
function selectedBlogLoop() {
	...
	for (i = 0; i < $data.length; i++) {
	    ...
	    obj.comments_count = obj.comments_count || '0';
	   	...
	   	var $date = '<div class="date"><span class="day">' + $dow + '</span><span class="yam">' + $yam + '</span></div>',
	   	$content = '<div class="feed-left col-md-6 col-sm-12 col-xs-12"><a target="_blank" href="' + $link + '">' + $date + '' + $image + '</a></div><div class="feed-right col-md-6 col-sm-12 col-xs-12"><h4><a target="_blank" href="' + $link + '">' + obj.title + '</a></h4><p>' + $comments_count + ' comments</p><p>' + $excerpt + '</p></div>';
