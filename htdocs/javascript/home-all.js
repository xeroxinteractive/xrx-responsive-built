...
if (document.getElementById("player")) {
  ...
  function onPlayerReady(event) {
    ...
    var videoPosterClick = function() {
      ...
      xrx_sitecatalyst_action('youtube play');
  ...
  function onPlayerStateChange(event) {
    xrx_sitecatalyst_action('youtube event.data' + event.data);
    var done = false;
    if (event.data === 0) {
      alert('done');
      xrx_sitecatalyst_action('youtube done event.data' + event.data);
      console.log('youtube done event.data' + event.data);
...
(function($) {
    if ($(".rd-selection")[0]) {
        ...
        $('.resource-desk').on('click', '#elicit-submit', function (e) {
            ...
            console.log('hmpg-ac-desk-' + $curText);
