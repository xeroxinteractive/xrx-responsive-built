...
function noResultsError() {
	...
	$('.blog-side').html('<div class="feed-error"><div class="col-md-1 col-sm-1 col-xs-1"><div class="icon"></div></div><div class="col-md-11 col-sm-11 col-xs-11"><div class="error-title">' + $errorTitle + '</div><p>' + $errorText + '</p></div></div>');
...
function blogBuilder(obj) {
	 ...
	 if (obj.image_link) {
	 	...
	 	$post.image = '<img src="../images/x-homepage/blogs_default_image.png"  />';
	 }
...
function noSocialError() {
	...
	$('.social-side').html('<div class="feed-error"><div class="col-md-1 col-sm-1 col-xs-1"><div class="icon"></div></div><div class="col-md-11 col-sm-11 col-xs-11"><div class="error-title">' + $errorTitle + '</div><p>' + $errorText + '</p></div></div>');
}	
	 ...
	 // updated = (new Date('updated')).toUTCString();
	  	...
	  	function linkIN() {
	  	    ...
	  	    var $feed = {};
	  	   	...
	  	   	$feed.TWtimeago = words();
	  	   	$feed.LItimeago = linkIN();
	  	   	...
	  	   	//	86400000
	  	  		...
	  	  		$feed.reply = '<a class="reply" ' + $newTab + ' href="https://twitter.com/intent/tweet?in_reply_to=' + obj.native_id +'">Reply</a>',
	  	   		...
	  	   		if (isIE8()) { $('.tweet-text a[href^="http://"]').attr('target','_blank'); }
	  	   	}
...
var videoPoster = document.getElementById('play-container');
